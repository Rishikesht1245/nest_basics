import { Body, Controller, Get, Header, Headers, HttpStatus, Inject, Param, Post, Query, Redirect, Req, Res } from "@nestjs/common";
...
export class AuthController {
    ...
    @Post("sign-in")
    loginUser(@Query('username') username : string){
        console.log(username)
        return this.authService.loginUser(username);
    }
